...
class Main extends Component {
    ...
    render() {
            return ( <
                    ...
                    component = {
                        () => < Confirm resetFeedbackForm = { this.props.resetFeedbackForm }
                        ...
                        component = {
                            ...
                            render = {
                                ...
                                component = {
                                    () => < Scan resetFeedbackForm = { this.props.resetFeedbackForm }
                                    postFeedback = { this.props.postFeedback }
                                    />} / > /> <
                                    Route exact path = '/seeyou'
                                    component = {
                                        () => < Seeyou resetFeedbackForm = { this.props.resetFeedbackForm }
                                        postFeedback = { this.props.postFeedback }
                                        />} / >
                                        <
                                        Redirect to = "/Signin" / >
